...
options = st.sidebar.radio("Choose a section", ["Home", "Register", "View Participants"])

if options == "Home":
    # Home Page
    st.title("Welcome to the Event Registration App!")
    st.write(
        """
        This app helps you manage event registrations efficiently.
        Use the **Register** tab to add participants, and the **View Participants** tab to see all registered participants.
        """
    )
...
elif options == "View Participants":
    # View Participants Page
    st.title("View Registered Participants")
